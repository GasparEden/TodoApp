...
var editTodo = function (elem, id) {
    if (elem.checked) {
        todos.find(function (v) { return v['id'] == id; })['done'] = true;
    }
    else {
        todos.find(function (v) { return v['id'] == id; })['done'] = false;
    }
    render();
};
